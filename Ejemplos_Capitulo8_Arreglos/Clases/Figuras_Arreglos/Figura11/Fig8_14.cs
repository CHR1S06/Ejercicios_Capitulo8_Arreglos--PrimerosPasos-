...
namespace Ejemplos_Capitulo8_Arreglos.Clases.Figuras_Arreglos.Figura11
{
    public class Fig8_14
    {
        public static void MenuFig_11()
        {
            ...
            //prueba si PrimerDoble cambio la referencia 
            ...
            //imprime el contenido de segundoArreglo antes de la llamada al metodo
            for (int i = 0; i < segundoArreglo.Length; i++)
            {
                Console.Write("{0} ", segundoArreglo[i]);
            }

            //pasa la variable segundoArrglo por referencia a SegundoDoble
            ...
            //prueba si SegundoDoble cambio la referencia
        ...
        public static void PrimerDoble(int[] arreglo)
        {
            ...
            //crea un nuevo objeto y asigna su referencia a arreglo 
            arreglo = new int[] { 11, 12, 13 };
        } //fin del metodo PrimerDoble
        ...
        public static void SegundoDoble(ref int[] arreglo)
        {
            ...
            arreglo = new int[] { 11, 12, 13 };
        } //fin del metodo SegundoDoble
    } //fin de la clase PruebaReferenciaArreglo 
}
